...
public class DescriptorArrayType implements IDescriptorFieldPart {
    public IDescriptorFieldPart arrayType;
    public int dimensions;

    public DescriptorArrayType(String string) {
        dimensions = 1;
        int pos;
    ...
    public boolean equals(Object o) {
        ...
        DescriptorArrayType that = (DescriptorArrayType) o;
