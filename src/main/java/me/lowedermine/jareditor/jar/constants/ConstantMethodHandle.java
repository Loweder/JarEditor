...
public class ConstantMethodHandle implements IConstant, ILoadable {
    ...
    public ConstantMethodHandle(DataInputStream in) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        ConstantMethodHandle that = (ConstantMethodHandle) o;
